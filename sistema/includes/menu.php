...
<ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
	...
	<a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.php">
		...
		<div class="sidebar-brand-text mx-3">TIENDA KABOD</div>
	</a>
	...
	<?php } ?>
	<!-- Nav Item - Productos fabrica Collapse Menu -->
	<?php if ($_SESSION['rol']  == 3 || $_SESSION['rol'] == 2 || $_SESSION['rol'] == 1){ ?>
	<li class="nav-item">
		<a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#collapseFabrica" aria-expanded="true" aria-controls="collapseFabrica">
			<i class="fas fa-fw fa-industry"></i>
			<span>Producción</span>
		</a>
		<div id="collapseFabrica" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
			<div class="bg-white py-2 collapse-inner rounded">
				<a class="collapse-item" href="registro_producto_fabrica.php">Nueva Producción</a>
				
				<a class="collapse-item" href="lista_productos_fabrica.php">Producción</a>
