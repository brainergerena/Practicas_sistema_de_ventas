 <?php include_once "includes/header.php";
  ...
  if (!empty($_POST)) {
    ...
    if (empty($_POST['proveedor']) || empty($_POST['producto']) || empty($_POST['precio']) || $_POST['precio'] <  0 || empty($_POST['cantidad'] || $_POST['cantidad'] <  0 || empty($_POST['calidad']) || empty($_POST['peso'])  || empty($_POST['volumen']) || empty($_POST['tamaño']) || empty($_POST['empaque']) || empty($_POST['fecha']))) {
      ...
      $query_insert = mysqli_query($conexion, "INSERT INTO producto(proveedor,descripcion,precio,existencia,calidad,peso,volumen,tamaño,empaque,fecha, usuario_id) values ('$proveedor', '$producto', '$precio', '$cantidad','$calidad','$peso','$volumen','$tamaño','$empaque','$fecha','$usuario_id')");
      if ($query_insert) {
