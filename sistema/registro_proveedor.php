            ...
            <div class="card">
                <form action="" autocomplete="off" method="post" class="card-body p-2">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" placeholder="Ingrese nombre de la empresa" name="proveedor" id="nombre" class="form-control">
                    </div>
                    <div class="form-group">
                        <label for="contacto">NIT</label>
                        <input type="number" placeholder="Ingresa Numero" name="contacto" id="contacto" class="form-control">
                    </div>
                    <div class="form-group">
