...
if (empty($_REQUEST['id'])) {
    ...
    $query_producto = mysqli_query($conexion, "SELECT codproducto, descripcion, proveedor, precio, existencia,calidad,peso,volumen,tamaño,empaque,fecha FROM producto WHERE codproducto = $id_producto");
